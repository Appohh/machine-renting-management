    ...
    public class CreateMachineRequestModel extends CreateProductRequestModel {
        ...
        public CreateMachineRequestModel(String name, String description, int status, BigDecimal price, List<MultipartFile> files, String machineSpecificField, Set<Category> category) {
